...
## Recent Changes
- 2025-11-28: Added Google Gemini API (gemini-2.5-flash) as primary AI with intelligent cascade fallback
- 2025-11-28: Implemented three-tier AI system: Gemini → OpenAI → Local rule-based AI
